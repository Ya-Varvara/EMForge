from calculations.inversion import fit_1d_model, get_z_from_edi, forward_1D_MT, calc_phase
from calculations.normalization import mtedi
...
class InversionModel:
    def __init__(self, edi_file_path, ro_init, h_init, is_fixed_ro, is_fixed_h, component, N_iter=10, min_res=0.1,
                 max_res=10000):
